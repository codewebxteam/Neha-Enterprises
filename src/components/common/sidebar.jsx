...
const AccountSidebar = ({ isOpen, onClose }) => {
  ...
  useEffect(() => {
    if (isOpen) {
      const saved = localStorage.getItem('gokulgorakhpur_recently_viewed');
          ...
          >
            ...
            <div className="p-8 border-t border-slate-50 bg-white">
              ...
              <div className="mt-6 flex justify-center gap-4 text-slate-300">
                ...
                <span className="text-[8px] font-black uppercase tracking-widest opacity-20">•</span>
                <span className="text-[8px] font-black uppercase tracking-widest hover:text-slate-600 cursor-pointer">Gokul V1.2</span>
              </div>
            </div>
          </motion.aside>
        </>
