...
const CartPage = () => {
    ...
    if (cartItems.length === 0) {
        return (
            <main className="min-h-screen bg-[#fdfbf7] pt-[138px] sm:pt-[154px] flex items-center justify-center font-['Montserrat',sans-serif]">
                <div className="container mx-auto px-6 text-center">
                    ...
                    >
                        ...
                        <div className="mb-6 flex justify-center">
                            <div className="w-24 h-24 border-4 border-[#27318a]/10 rounded-3xl flex items-center justify-center bg-white">
                                <ShoppingBag size={48} strokeWidth={2.5} className="text-[#27318a]" />
                            </div>
                        </div>

                        {/* Text Content */}
                        <h2 style={{ fontFamily: "'Recoleta', Georgia, serif" }} className="text-3xl font-black text-[#27318a] tracking-tight mb-3">Your Cart is Empty</h2>
                        ...
                        <button
                            ...
                            className="px-10 py-4 text-[#27318a] rounded-[2rem] text-xs font-black uppercase tracking-widest hover:brightness-105 transition-all shadow-xl shadow-slate-200 active:scale-95 flex items-center gap-3"
                        >
                            Start Exploring
                            <ArrowRight size={16} />
                        </button>
            ...
            <Link to={`/product/${item.id}`} className="flex flex-col sm:flex-row items-center gap-5 flex-1 group/link cursor-pointer min-w-0 pointer-events-auto">
                ...
                <div className="flex-1 min-w-0 text-center sm:text-left">
                    <div className="flex flex-wrap items-center gap-2 mb-2 justify-center sm:justify-start">
                        <span className="text-[8px] font-black uppercase tracking-widest px-3 py-1.5 rounded-full bg-blue-50 text-[#27318a] border border-[#27318a]/10">
    ...
    return (
        <>
            <main className="min-h-screen bg-[#fdfbf7] pt-[138px] sm:pt-[154px] pb-32 font-['Montserrat',sans-serif]">
                <div className="container mx-auto px-2 sm:px-4 lg:px-8">
                    ...
                    >
                        <div className="flex items-baseline gap-4">
                            <h1 style={{ fontFamily: "'Recoleta', Georgia, serif" }} className="text-[32px] sm:text-[40px] font-bold text-[#27318a] tracking-tight leading-none">
                                Cart.
                            </h1>
                    ...
                    <div className="flex flex-col lg:flex-row gap-8 lg:gap-12">
                        ...
                        <div className="flex-1 space-y-8">
                            ...
                            <motion.div
                                ...
                                className="bg-[#27318a] text-white rounded-[1.5rem] sm:rounded-[3.5rem] p-6 sm:p-10 lg:p-12 sticky top-28 shadow-2xl shadow-slate-200"
                            >
                                <div className="flex items-center gap-4 mb-10">
                                    <div className="w-12 h-12 rounded-2xl bg-white/10 border border-white/10 flex items-center justify-center">
                                        <ShoppingCart size={22} className="text-[#fce513]" />
                                    </div>
                                    <h3 style={{ fontFamily: "'Recoleta', Georgia, serif" }} className="text-[28px] font-bold tracking-wide">Summary.</h3>
                                </div>

                                <div className="space-y-6 mb-10">
                                    <div className="flex justify-between items-center opacity-70">
                                        <span className="text-[14px] font-bold uppercase tracking-widest font-sans">Subtotal</span>
                                        <span className="text-[16px] font-black">₹{subtotal.toLocaleString('en-IN')}</span>
                                    </div>

                                    <div className="flex justify-between items-center opacity-70">
                                        <span className="text-[14px] font-bold uppercase tracking-widest font-sans">Tax / GST ({gstPercentage}%)</span>
                                        <span className="text-[16px] font-black">₹{tax.toLocaleString('en-IN')}</span>
                                    </div>

                                    <div className="flex justify-between items-center mt-6">
                                        <span className="text-[14px] font-bold uppercase tracking-widest font-sans text-[#fce513]">Delivery</span>
                                        <span className={`text-[12px] font-black px-3 py-1 rounded-full uppercase ${shippingFee > 0 ? 'bg-white/20 text-white' : 'bg-[#fce513] text-[#27318a]'}`}>
                                    ...
                                    <div className="pt-8 border-t border-white/20">
                                        <div>
                                            <p className="text-[14px] font-bold uppercase tracking-[0.2em] text-white/60 mb-3">Grand Total</p>
                                            <p className="text-[32px] font-black tracking-tighter leading-none text-[#fce513]">₹{grandTotal.toLocaleString('en-IN')}</p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <motion.button
                                    ...
                                    style={{ backgroundColor: '#fce513' }}
                                    className="w-full mt-10 py-4 sm:py-5 text-[#27318a] rounded-full text-sm sm:text-[16px] font-black uppercase tracking-wider sm:tracking-[0.2em] flex items-center justify-center gap-2 sm:gap-3 shadow-[0_15px_30px_rgba(252,229,19,0.15)] hover:brightness-105 transition-all group"
                                >
