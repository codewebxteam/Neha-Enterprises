                    ...
                    <div className="flex min-h-full items-center justify-center p-4">
                        ...
                        >
                            ...
                            <motion.button
                                ...
                                disabled={isLoading}
                                className={`w-full flex items-center justify-center gap-3 py-3.5 border border-[#27318a]/20 rounded-2xl text-slate-900 text-sm font-bold transition-all ${isLoading ? 'opacity-70 cursor-not-allowed' : ''}`}
                            >
